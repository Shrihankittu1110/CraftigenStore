...
### Local Environment Setup (Updated)

Use the included environment files:
...
Default values already added:

```bash
# backend/.env
PORT=5000
CLIENT_URL=http://localhost:3000
MONGO_URI=mongodb://127.0.0.1:27017/craftigenstore
```
...
If your frontend install fails because of peer dependency conflicts, use:
